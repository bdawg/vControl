function varargout = vControl_HWPPosFn(varargin)
% VCONTROL_HWPPOSFN MATLAB code for vControl_HWPPosFn.fig
%      VCONTROL_HWPPOSFN, by itself, creates a new VCONTROL_HWPPOSFN or raises the existing
%      singleton*.
%
%      H = VCONTROL_HWPPOSFN returns the handle to a new VCONTROL_HWPPOSFN or the handle to
%      the existing singleton*.
%
%      VCONTROL_HWPPOSFN('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VCONTROL_HWPPOSFN.M with the given input arguments.
%
%      VCONTROL_HWPPOSFN('Property','Value',...) creates a new VCONTROL_HWPPOSFN or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vControl_HWPPosFn_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vControl_HWPPosFn_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vControl_HWPPosFn

% Last Modified by GUIDE v2.5 04-Apr-2013 11:20:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vControl_HWPPosFn_OpeningFcn, ...
                   'gui_OutputFcn',  @vControl_HWPPosFn_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vControl_HWPPosFn is made visible.
function vControl_HWPPosFn_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vControl_HWPPosFn (see VARARGIN)

%%%%%%%%%%%% Settings %%%%%%%%%%%%%%
delayTime = 2; % Time to wait between iterations
startAngle = 25.0; % Angle to start scan at
endAngle = 65.0;   % Angle to finish scan at
nSteps = 60;    % Number of angle steps
boxSize = 30;   % Size of measurement box (pixels)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

setappdata(handles.lcvrCalGui,'delayTime',delayTime)
setappdata(handles.lcvrCalGui,'startVolt',startAngle)
setappdata(handles.lcvrCalGui,'endVolt',endAngle)
setappdata(handles.lcvrCalGui,'boxSize',boxSize)
setappdata(handles.lcvrCalGui,'nSteps',nSteps)

% Choose default command line output for vControl_HWPPosFn
...
% UIWAIT makes vControl_HWPPosFn wait for user response (see UIRESUME)
% uiwait(handles.lcvrCalGui);


% --- Outputs from this function are returned to the command line.
function varargout = vControl_HWPPosFn_OutputFcn(hObject, eventdata, handles) 
...
for volt = startVolt:stepSize:endVolt
    allVolts(count)=volt + getappdata(handles.vCamGui,'hwpCalOffset');
    %lcvrV1=volt;

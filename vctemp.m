...
%     pause(1)
    ...
    hdrCards=strcat('SERITIME:',startserietime(1:15),':Start time of serie&UTSTTIME:',startaqtime(1:15),':Start time of cube&UTNDTIME:',endtime(1:15),':End time of cube&LOCTIME:',datestr(now),'&SAVFOLD:',savefold,':On lestat machine&FILENAME:',filenameonly,'&FILENUM:',num2str(file_num),'.fits:Origininally',...
        '&RA:',restelstatus{2},'J2000&DEC:',restelstatus{3},'J2000&TIMING:',timingFile,':Timing file name&EMGAIN:',emGainS,'&QWP1:',num2str(caldAngle1),'&QWP2:',num2str(caldAngle2),...
